...
/// <summary>
/// Represents a validator that validates if a collection has count of elements between N and M exclusively.
/// </summary>
public class HasElementsBetweenExclusiveValidator<T, TElement> : PropertyValidator<T, IEnumerable<TElement>?>
{
    ...
    public HasElementsBetweenExclusiveValidator(int countFrom, int countTo)
    {
    ...
    protected override string GetDefaultMessageTemplate(string errorCode)
        => $"'{{PropertyName}}' collection must count of elements between {_countFrom} and {_countTo} exclusively.";
}